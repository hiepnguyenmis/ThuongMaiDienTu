...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_USERS_CUSTOMERS_USER_ID_idx` (`user_id`),
  CONSTRAINT `FK_CUSTOMERS_USERS_USER_ID` FOREIGN KEY (`user_id`) REFERENCES `customers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `delivery_addresses` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_CUSTORMER_ADDRESSES_CUSTOMER_CUSTOMER_ID_idx` (`customer_id`),
  CONSTRAINT `FK_CUSTORMER_ADDRESSES_CUSTOMER_CUSTOMER_ID` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `employees` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_EMPLOYEE_USERS_USER_ID_idx` (`users_id`),
  CONSTRAINT `FK_EMPLOYEE_USERS_USER_ID` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `shiped_date` date DEFAULT NULL,
  `tolal_money` varchar(45) NOT NULL,
  ...
  UNIQUE KEY `deliver_address_id_UNIQUE` (`deliver_address_id`),
  UNIQUE KEY `received_status_UNIQUE` (`received_status`),
  KEY `FK_ORDERS_CUSTOMERS_ID_CUSTOME_idx` (`customer_id`),
  KEY `FK_ORDERS_EMPLOYEES_ID_EMPLOYEE_idx` (`employee_id`),
  KEY `FK_ORSERS_ADDRESS_ADDRESS_ID_idx` (`deliver_address_id`),
  CONSTRAINT `FK_ORDERS_CUSTOMERS_ID_CUSTOME` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`),
  CONSTRAINT `FK_ORDERS_EMPLOYEES_ID_EMPLOYEE` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`),
  CONSTRAINT `FK_ORSERS_ADDRESS_ADDRESS_ID` FOREIGN KEY (`deliver_address_id`) REFERENCES `delivery_addresses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `products_vouchers`
--

DROP TABLE IF EXISTS `products_vouchers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `products_vouchers`
--

LOCK TABLES `products_vouchers` WRITE;
/*!40000 ALTER TABLE `products_vouchers` DISABLE KEYS */;
/*!40000 ALTER TABLE `products_vouchers` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `promotions_products` WRITE;
/*!40000 ALTER TABLE `promotions_products` DISABLE KEYS */;
/*!40000 ALTER TABLE `promotions_products` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `resources_roles` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_ROLE_RESOURCE_ROLES_RESOUCRE_ID_idx` (`role_id`),
  KEY `FK_RESOURCE_ROLE_RESOUCRE_RESOURCE_ID_idx` (`resource_id`),
  CONSTRAINT `FK_RESOURCE_ROLE_RESOUCRE_RESOURCE_ID` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`),
  CONSTRAINT `FK_ROLE_RESOURCE_ROLES_RESOUCRE_ID` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
