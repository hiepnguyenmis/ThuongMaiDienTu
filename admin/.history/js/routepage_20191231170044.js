var app = angular.module("myApp", ['ui.router','ckeditor', 'chart.js',"ngStorage",'ngFileUpload', 'naif.base64', 'angular-sessionstorage']);
...
app.run(
  function run($rootScope, $http, $location, $localStorage) {
    ...
    $rootScope.Logout=function(){
      //$rootScope.account =  $localStorage.currentUser;
